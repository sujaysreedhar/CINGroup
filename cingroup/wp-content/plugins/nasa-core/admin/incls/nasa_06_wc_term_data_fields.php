...
if (!class_exists('Nasa_WC_Term_Data_Fields')) {
    ...
    class Nasa_WC_Term_Data_Fields {
        ...
        public function taxonomy_cat_header_footer_type($term = null) {
            ...
            $menu_options = nasa_meta_getListMenus();
            ...
            if (is_object($term) && $term) {
                ...
                if (!$cat_header_vertical_menu = get_term_meta($term->term_id, $this->_cat_header_vertical_menu)) {
                    $cat_header_vertical_menu = add_term_meta($term->term_id, $this->_cat_header_vertical_menu, '');
                }
        ...
        public function taxonomy_logo_edit($term) {
            ...
            <tr class="form-field with-logo nasa-term-root hidden-tag">
            ...
            <tr class="form-field with-logo-retina nasa-term-root hidden-tag">
