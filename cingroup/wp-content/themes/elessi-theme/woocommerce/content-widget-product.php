        ...
        <?php if($list_type != '1') : ?>
            ...
            <div class="product-interactions">
                ...
                <?php if(NASA_WISHLIST_ENABLE && $nasa_wishlist) : ?>
                    <a href="javascript:void(0);"  class="<?php echo ($list_type == 'list_extra') ? 'btn-wishlist btn-link wishlist-icon btn-wishlist-main-list' : 'btn-wishlist'; ?>" data-prod="<?php echo esc_attr($productId); ?>" data-prod_type="<?php echo esc_attr($product->get_type()); ?>">
